...
export const dict = {
  en: {
    ...
    projects: {
      ...
      items: [
        {
          name: "Overseas growth service",
          tag: "Diagnosis → setup → optional gain-share",
          status: "Open to clients",
          body: "A bilingual bridge for going global — I help Chinese brands build their overseas social, creator, and growth systems from zero.",
  ...
  zh: {
    ...
    projects: {
      ...
      items: [
        {
          name: "出海增长服务",
          tag: "诊断钩子 → 项目制 setup → 可选对赌",
          status: "接客户中",
          body: "一座中英双语的桥 帮中国品牌把海外社媒 达人 增长系统从 0 搭通",
          href: "/services/growth",
        },
        {
          name: "Life OS",
